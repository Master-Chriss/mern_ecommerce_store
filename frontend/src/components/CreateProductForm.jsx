		...
		>
			...
			<form onSubmit={handleSubmit} className='space-y-4'>
				...
				<div className='mt-1 flex items-center'>
					...
					<label
						htmlFor='image'
						className='cursor-pointer bg-white py-2 px-3 border border-gray-300 rounded-md shadow-sm text-sm leading-4 font-medium text-gray-700 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-400'
					>
				...
				<button
					...
					focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-400 disabled:opacity-50'
					disabled={loading}
				>
					{loading ? (
						<>
